...
import { registerKill } from './commands/kill.ts';
import { registerLogs } from './commands/logs.ts';
import { registerMods } from './commands/mods.ts';
import { registerRcon } from './commands/rcon.ts';
import { registerRestart } from './commands/restart.ts';
import { registerService } from './commands/service.ts';
